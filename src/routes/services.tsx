  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Independent third-party assistance topics including Wi-Fi guidance, broadband questions, router setup walkthroughs, cable TV navigation and more. We are not an ISP.",
      },
      { property: "og:title", content: "Home Fiber Connection — Assistance Topics" },
      {
        property: "og:description",
        content: "Independent third-party assistance for internet, Wi-Fi and cable TV concerns.",
      },
...
const blocks = [
  {
    ...
    points: [
      ...
      "General troubleshooting context",
  ...
  },
  {
    ...
    points: [
      ...
      "Reading a cable TV bill",
      "Common add-on terminology",
  ...
  },
  {
    ...
    points: [
      "Issue-context guidance",
      "Questions to bring to your provider",
      "Plain-language explanations",
      "No impersonation of providers",
    ],
  },
  {
        ...
        <div className="container mx-auto px-6 lg:px-10">
          <Reveal>
            ...
            <h1 className="font-display text-5xl md:text-7xl mt-4 max-w-3xl text-balance">
              Where independent <span className="font-serif-italic text-amber">guidance</span>{" "}
              helps.
            </h1>
            <p className="mt-6 max-w-2xl text-muted-foreground text-lg leading-relaxed">
              Home Fiber Connection provides general informational support for internet, broadband,
              Wi-Fi and cable TV concerns. We are an independent third-party startup — not an ISP,
              not affiliated with any provider, and we do not sell plans or subscriptions.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="py-12">
            ...
            <Reveal key={b.title}>
              ...
              >
                ...
                <div className="lg:col-span-6 [direction:ltr]">
                  ...
                  <a
                    href="tel:8884784101"
                    className="mt-8 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground shadow-glow-red hover:scale-[1.03] transition-transform"
                  >
        ...
        <div className="container mx-auto px-6 lg:px-10 mt-20">
          <p className="text-xs text-muted-foreground max-w-3xl leading-relaxed">
            Disclaimer: Home Fiber Connection is an independent third-party service assistance
            provider. We are not affiliated with, authorized by, or endorsed by any internet,
            broadband, or cable TV service provider. Brand names, if mentioned, are used strictly
            for informational purposes only. Our service assistance fee is separate from any
            provider charges.
          </p>
        </div>
      </section>
