      ...
      <div className="relative container mx-auto px-6 lg:px-10 py-20 grid lg:grid-cols-4 gap-12">
        <div>
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Home Fiber Connection is an independent third-party service assistance startup, launched
            in 2026. We provide general guidance and informational support related to internet,
            broadband, Wi-Fi and cable TV services.
          </p>
        </div>

        <div>
          <h4 className="text-xs uppercase tracking-[0.25em] text-amber mb-5 font-semibold">
            Explore
          </h4>
      ...
      <div className="relative border-t border-border/40">
        <div className="container mx-auto px-6 lg:px-10 py-6 text-xs text-muted-foreground leading-relaxed">
          <p className="max-w-5xl">
            <strong className="text-foreground">Disclaimer:</strong> Home Fiber Connection is an
            independent third-party service assistance startup. We are not affiliated with,
            authorized by, sponsored by, or endorsed by any internet, broadband, cable TV, or
            streaming service provider. Brand names, if mentioned anywhere on this site, are
            trademarks of their respective owners and are used strictly for informational purposes
            only. Our service assistance fee is separate from any provider charges.
          </p>
        </div>
